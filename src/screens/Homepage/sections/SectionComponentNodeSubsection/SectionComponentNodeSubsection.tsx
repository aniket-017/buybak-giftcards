...
export const SectionComponentNodeSubsection = (): JSX.Element => {
  return (
    ...
    >
      <article className="flex flex-col w-[260px] items-center gap-10 px-0 py-10 relative">
        <h3 className="relative w-[237px] h-[88px] mt-[-1.00px] [font-family:'Figtree',Helvetica] font-normal text-neutralsa-8b-0ad text-3xl text-center tracking-[-0.60px] leading-[normal]">
          Traditional <br />
          Rewards
        </h3>
          ...
          {traditionalRewardsItems.map((item) => (
            ...
            >
              <img
                ...
                src={item.lineSrc}
              />
              <div className="relative w-fit font-web-body font-[number:var(--web-body-font-weight)] text-neutrals-7a-8a-85 text-[length:var(--web-body-font-size)] tracking-[var(--web-body-letter-spacing)] leading-[var(--web-body-line-height)] whitespace-nowrap [font-style:var(--web-body-font-style)]">
                {item.content}
              </div>
            </li>
          ))}
          ...
          {buyBakItems.map((item) => (
            ...
            >
              <img
                ...
                src={item.lineSrc}
              />
              <div className="font-[number:var(--web-body-font-weight)] text-blues-0d-2137 text-[length:var(--web-body-font-size)] relative w-fit font-web-body tracking-[var(--web-body-letter-spacing)] leading-[var(--web-body-line-height)] whitespace-nowrap [font-style:var(--web-body-font-style)]">
                {item.content}
              </div>
            </li>
          ))}
